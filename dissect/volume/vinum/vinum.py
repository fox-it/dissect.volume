        ...
        for volume_id, plexes in plexes_by_volume.items():
            ...
            if plexes:
                ...
                if len(plexes) == 1:
                    ...
                    # are named automatically, so they have a pseudo order due
                    # to there names being constructed with p0, p1, etc.
